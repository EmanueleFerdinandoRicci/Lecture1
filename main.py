...
from gestionale.ordini import Ordine,RigaOrdine,OrdineSconto
...
from gestionale.prodotti import ProdottoScontato as ps # gli do anche un nome alternativo
p3 = ps(name="Auricolari",price=230,quantity=1,supplier="AAA",sconto_percento=10)
from gestionale import prodotti as p
